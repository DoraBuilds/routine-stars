...
export const ICON_OPTIONS = [
  // Core
  { key: 'bed',           emoji: '🛏️',  label: 'Bed',        routines: ['morning'],           category: 'core' },
  { key: 'sparkles',      emoji: '✨',   label: 'Sparkles',   routines: ['morning', 'evening'], category: 'core' },
  { key: 'package-open',  emoji: '📦',   label: 'Put away',   routines: ['morning', 'evening'], category: 'core' },
  { key: 'alarm-clock',   emoji: '⏰',   label: 'Wake up',    routines: ['morning'],            category: 'core' },
  { key: 'sun',           emoji: '☀️',   label: 'Outside',    routines: ['morning', 'evening'], category: 'core' },
  { key: 'star',          emoji: '⭐',   label: 'Star',       routines: ['morning', 'evening'], category: 'core' },
  { key: 'trophy',        emoji: '🏆',   label: 'Trophy',     routines: ['morning', 'evening'], category: 'core' },
  { key: 'wand',          emoji: '🪄',   label: 'Magic',      routines: ['morning', 'evening'], category: 'core' },
  // Self-care
  { key: 'toilet',        emoji: '🚽',   label: 'Toilet',     routines: ['morning', 'evening'], category: 'self-care' },
  { key: 'shower-head',   emoji: '🚿',   label: 'Shower',     routines: ['morning', 'evening'], category: 'self-care' },
  { key: 'bath',          emoji: '🛁',   label: 'Bath',       routines: ['evening'],            category: 'self-care' },
  { key: 'brush',         emoji: '🪥',   label: 'Brush teeth',routines: ['morning', 'evening'], category: 'self-care' },
  { key: 'scissors',      emoji: '✂️',   label: 'Hair',       routines: ['morning', 'evening'], category: 'self-care' },
  { key: 'hand',          emoji: '🧼',   label: 'Wash hands', routines: ['morning', 'evening'], category: 'self-care' },
  { key: 'pill',          emoji: '💊',   label: 'Medicine',   routines: ['morning', 'evening'], category: 'self-care' },
  { key: 'dumbbell',      emoji: '🏋️',   label: 'Exercise',   routines: ['morning', 'evening'], category: 'self-care' },
  { key: 'biceps-flexed', emoji: '💪',   label: 'Strong',     routines: ['morning', 'evening'], category: 'self-care' },
  { key: 'snowflake',     emoji: '❄️',   label: 'Winter gear',routines: ['morning'],            category: 'self-care' },
  // Meal
  { key: 'utensils',      emoji: '🍽️',   label: 'Eating',     routines: ['morning', 'evening'], category: 'meal' },
  { key: 'chef-hat',      emoji: '🍳',   label: 'Kitchen',    routines: ['morning', 'evening'], category: 'meal' },
  { key: 'apple',         emoji: '🍎',   label: 'Apple',      routines: ['morning', 'evening'], category: 'meal' },
  { key: 'banana',        emoji: '🍌',   label: 'Banana',     routines: ['morning', 'evening'], category: 'meal' },
  { key: 'sandwich',      emoji: '🥪',   label: 'Sandwich',   routines: ['morning', 'evening'], category: 'meal' },
  { key: 'salad',         emoji: '🥗',   label: 'Salad',      routines: ['morning', 'evening'], category: 'meal' },
  { key: 'pizza',         emoji: '🍕',   label: 'Pizza',      routines: ['morning', 'evening'], category: 'meal' },
  { key: 'egg',           emoji: '🥚',   label: 'Egg',        routines: ['morning'],            category: 'meal' },
  { key: 'milk',          emoji: '🥛',   label: 'Milk',       routines: ['morning', 'evening'], category: 'meal' },
  { key: 'glass-water',   emoji: '💧',   label: 'Water',      routines: ['morning', 'evening'], category: 'meal' },
  { key: 'cup-soda',      emoji: '🥤',   label: 'Drink',      routines: ['morning', 'evening'], category: 'meal' },
  { key: 'cookie',        emoji: '🍪',   label: 'Snack',      routines: ['morning', 'evening'], category: 'meal' },
  { key: 'ice-cream',     emoji: '🍦',   label: 'Ice cream',  routines: ['morning', 'evening'], category: 'meal' },
  // Prep
  { key: 'shirt',         emoji: '👕',   label: 'Clothes',    routines: ['morning', 'evening'], category: 'prep' },
  { key: 'footprints',    emoji: '👟',   label: 'Shoes',      routines: ['morning'],            category: 'prep' },
  { key: 'backpack',      emoji: '🎒',   label: 'Backpack',   routines: ['morning'],            category: 'prep' },
  { key: 'pencil',        emoji: '✏️',   label: 'Homework',   routines: ['morning', 'evening'], category: 'prep' },
  { key: 'bike',          emoji: '🚲',   label: 'Bike',       routines: ['morning', 'evening'], category: 'prep' },
  // Wind-down
  { key: 'moon-star',     emoji: '🌙',   label: 'Bedtime',    routines: ['evening'],            category: 'wind-down' },
  { key: 'book-open',     emoji: '📚',   label: 'Reading',    routines: ['evening'],            category: 'wind-down' },
  { key: 'flame',         emoji: '🕯️',   label: 'Candle',     routines: ['evening'],            category: 'wind-down' },
  // Comfort / fun
  { key: 'smile',         emoji: '😊',   label: 'Smile',      routines: ['morning', 'evening'], category: 'comfort' },
  { key: 'heart',         emoji: '💕',   label: 'Love',       routines: ['morning', 'evening'], category: 'comfort' },
  { key: 'music',         emoji: '🎵',   label: 'Music',      routines: ['morning', 'evening'], category: 'comfort' },
  { key: 'palette',       emoji: '🎨',   label: 'Art',        routines: ['morning', 'evening'], category: 'comfort' },
  { key: 'puzzle',        emoji: '🧩',   label: 'Puzzle',     routines: ['morning', 'evening'], category: 'comfort' },
  { key: 'gamepad',       emoji: '🎮',   label: 'Game',       routines: ['morning', 'evening'], category: 'comfort' },
  { key: 'flower',        emoji: '🌸',   label: 'Flower',     routines: ['morning', 'evening'], category: 'comfort' },
  { key: 'bird',          emoji: '🐦',   label: 'Bird',       routines: ['morning', 'evening'], category: 'comfort' },
  { key: 'fish',          emoji: '🐟',   label: 'Fish',       routines: ['morning', 'evening'], category: 'comfort' },
  { key: 'baby',          emoji: '👶',   label: 'Baby',       routines: ['morning', 'evening'], category: 'comfort' },
